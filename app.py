...
.acct-lbl{font-size:11px;font-weight:600;text-transform:uppercase;letter-spacing:0.5px;color:#3d4a5c;flex-shrink:0;min-width:160px}
  ...
  <div class="page-body" {feed_col_hidden}>
    ...
    <div id="fview-accounts">
      <div class="page-section-header">
        <div>
          <div class="page-title">Account Data</div>
          <div class="page-sub">Live data pulled from your connected accounts</div>
        </div>
    ...
    <div id="fview-activity" style="display:none">
      <div style="margin-bottom:20px">
        ...
        <div class="page-sub">A live log of everything your agent does</div>
      </div>
